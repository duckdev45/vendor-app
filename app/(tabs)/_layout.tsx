...
export default function TabLayout() {
    ...
    // 計算動態樣式
    const dynamicStyles = vars({
        '--text-xs': 12 * fontScale,
        '--text-sm': 14 * fontScale,
        '--text-base': 16 * fontScale,
        '--text-lg': 18 * fontScale,
        '--text-xl': 20 * fontScale,
        '--text-2xl': 24 * fontScale,
        '--text-3xl': 30 * fontScale,
        '--text-4xl': 36 * fontScale,
    });
    ...
    return (
        <View style={[dynamicStyles, {flex: 1}]} className={colorScheme}>
            <Tabs
                screenOptions={{
